...
- The isolated C006 snapshot independently passed its 20 gameplay/VFX tests, four launcher tests, TypeScript, production build and all six C001-C006 strict validations. Linux CI verification follows the migration commit.
