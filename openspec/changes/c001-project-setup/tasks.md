...
- [x] 1.1 C001 Preserve template history and creator attribution, establish active OpenSpec root and verify strict C001 validation.
- [x] 1.2 C001 Document disjoint asset paths, coordinates, clips and navigation contract; verify coordinator handoff.
- [x] 1.3 C001 Install pinned dependencies with a lockfile; verify npm install succeeds.
